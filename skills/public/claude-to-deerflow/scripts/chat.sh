...
#   DEERFLOW_URL=http://host:2027 bash chat.sh "hi"   # custom endpoint
#
# Environment variables:
#   DEERFLOW_URL          — Unified proxy base URL (default: http://localhost:2027)
...
gateway_url = sys.argv[2].rstrip("/") if len(sys.argv) > 2 else "http://localhost:2027"
