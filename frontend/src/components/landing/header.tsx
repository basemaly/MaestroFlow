  ...
  return (
    <header className="container-md fixed top-0 right-0 left-0 z-20 mx-auto flex h-16 items-center justify-between backdrop-blur-xs">
      <div className="flex items-center gap-2">
        <a href="https://github.com/basemaly/MaestroFlow" target="_blank">
          <h1 className="font-serif text-xl text-yellow-400">MaestroFlow</h1>
        </a>
      </div>
...
async function StarCounter() {
  ...
  try {
    const response = await fetch(
      "https://api.github.com/repos/basemaly/MaestroFlow",
      {
