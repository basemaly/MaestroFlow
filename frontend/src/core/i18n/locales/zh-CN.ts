...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 MaestroFlow，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nMaestroFlow 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 MaestroFlow 的潜力。通过自定义技能，MaestroFlow\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    subagentModel: "子代理",
    subagentModelAuto: "自动 (Flash)",
    subagentModelDescription: "Ultra 模式下并行子代理使用的模型",
    searchModels: "搜索模型...",
    surpriseMe: "小惊喜",
    ...
    suggestions: [
      {
        suggestion: "润色",
        prompt: "把这段 AI 生成的文字改得更自然、更像真人写的，同时保持原意：[粘贴文本]",
        icon: PenLineIcon,
      },
      {
        suggestion: "批判",
        prompt:
          "从论点、证据、反方观点与反驳几个维度，批判性分析这篇文章或论证：[粘贴草稿]",
        icon: MicroscopeIcon,
      },
      {
        suggestion: "迭代",
        prompt:
          "把这段提示词或草稿做成迭代改进流程：先给初稿，再自我批判，最后输出更强版本：[粘贴内容]",
        icon: ShapesIcon,
      },
      {
        suggestion: "研究",
        prompt: "深入浅出地研究一下[主题]，并总结发现。",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 MaestroFlow 官方网站",
    githubTooltip: "访问 MaestroFlow 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 MaestroFlow",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 MaestroFlow",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 MaestroFlow 中使用",
  },
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 MaestroFlow 的界面和行为。",
    sections: {
      appearance: "外观",
      memory: "记忆",
      tools: "工具",
    ...
    memory: {
      title: "记忆",
      description:
        "MaestroFlow 会在后台不断从你的对话中自动学习。这些记忆能帮助 MaestroFlow 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      markdown: {
        overview: "概览",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 MaestroFlow 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "MaestroFlow 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
