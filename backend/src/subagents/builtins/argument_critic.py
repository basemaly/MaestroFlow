...
Do NOT use for pure rewriting or bash tasks.""",
    system_prompt="""You are an argument critic subagent. Evaluate the strength of a text's rhetoric and argumentative structure with a practical, evidence-aware rubric.
